...
public class RestoreArgs
{
    ...
    [ArgRange(0, 29), ArgDescription("Index of the save you want restore. If not set it will be extracted from the file if it still has the libNOM.io name format."), ArgPosition(3)]
