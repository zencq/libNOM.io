...
public class RestoreArgs
{
    ...
    [ArgRange(0, 29), ArgDescription("Index of the save you want restore. If not set it will be extracted from the file if it still has the libNOM.io name format. The index is expected to be: 0 for Slot1Auto, 1 for Slot1Manual, 2 for Slot2Auto, etc)."), ArgPosition(3)]
