...
public static class Constants
{
    ...
    internal static readonly Dictionary<string, string[]> JSONPATH = new()
    {
        ...
        { "GAME_VERSION_230", ["6f=..Xf4", "PlayerStateData..CurrentPos"] }, // exception as this is only used in Vanilla saves
        ...
        { "PLATFORM", ["8>q", "Platform"] }, // same path in Vanilla and Omega
        { "SAVE_NAME", ["6f=.Pk4", "PlayerStateData.SaveName", "<h0.Pk4", "CommonStateData.SaveName"] }, // path is in common in Omega
        ...
        { "DIFFICULTY_NPC_POPULATION", ["", "", "{0}.6f=.LyC.:fe.Z52.SdQ", "{0}.PlayerStateData.DifficultyState.Settings.NPCPopulation.NPCPopulationDifficulty"] },
        ...
        { "INTERSECTION_DISCOVERY_DATA_OWNERSHIP_EXPRESSION_PTK", ["@.ksu.D6b == '' || @.ksu.D6b == '{0}'", "@.OWS.PTK == '' || @.OWS.PTK == '{0}'"] },
        ...
        { "INTERSECTION_SETTLEMENT_OWNERSHIP_KEY", ["6f=.GQA[?({{0}})].3?K.{0}", "PlayerStateData.SettlementStatesV2[?({{0}})].Owner.{0}", "{0}.6f=.GQA[?({{{{0}}}})].3?K.{{0}}", "{0}.PlayerStateData.SettlementStatesV2[?({{{{0}}}})].Owner.{{0}}"] }, // two levels of interpolation (after context)
